...
interface StoryNode {
  ...
  text: string;
  choices: StoryChoice[];
  image?: string; // Optional background or illustration
}
...
interface StoryChoice {
  ...
  text: string;
  nextNodeId: string;
  consequences?: string; // Description of what this choice leads to
}

// Simple story data - in a real app, this might come from an API or be more complex
