...
import { Shield, Hourglass, Trophy, History, Play, UserPlus } from "lucide-react";
    ...
    <div className="space-y-8 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-darkFantasy-border pb-6">
        <div>
          ...
          <p className="text-darkFantasy-accent mt-1">Monitor your progress and achievements in the shadow realm.</p>
        </div>
        {!character && (
          <Link to="/character">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Card className="bg-darkFantasy-primary border-darkFantasy-border hover:border-darkFantasy-accent transition-colors">
          <CardContent className="p-6 flex items-center gap-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-darkFantasy-accent uppercase tracking-wider">Total Score</h3>
              <p className="text-3xl font-bold text-white mt-1">{stats.totalScore} <span className="text-sm font-normal text-darkFantasy-accent">points</span></p>
            </div>
          </CardContent>
        </Card>
      </div>
